...
| | | |
|:---:|:---:|:---:|
| ![今日屏：待处理统计与紧急分组，卡片下方是就地操作按钮](docs/screenshots/01-today.png) | ![清单屏：搜索框与按剩余天数排序的物品列表](docs/screenshots/02-list.png) | ![添加物品：品类横条、常见模板芯片、到期规则分段](docs/screenshots/03-add-template.png) |
| **今日** · 分组与就地操作 | **清单** · 搜索与状态标签 | **添加** · 品类与常见模板 |
| ![详情浮层：物品明细与最近记录，底部是固定的编辑与删除按钮](docs/screenshots/04-detail-sheet.png) | ![设置屏：每日提醒时间、外观、数据备份与概览](docs/screenshots/05-settings.png) | ![今日屏的暗色主题](docs/screenshots/06-today-dark.png) |
| **详情** · 页脚固定，内容从下方滑过 | **设置** · 提醒时间与备份 | **暗色** · 同一套 tonal 层级 |
