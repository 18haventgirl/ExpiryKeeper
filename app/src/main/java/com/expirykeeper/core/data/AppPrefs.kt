...
class AppPrefs(context: Context) {
    ...
    var dynamicColor: Boolean
        ...
        set(v) = p.edit { putBoolean("dynamicColor", v) }
    ...
    var reminderHour: Int
        ...
        set(v) = p.edit { putInt("reminderHour", v) }

    var reminderMinute: Int
        get() = p.getInt("reminderMinute", 0)
        set(v) = p.edit { putInt("reminderMinute", v) }
    ...
    var lastNotifiedDay: LocalDate?
        ...
        set(v) = p.edit {
            if (v == null) remove("lastNotifiedDay") else putLong("lastNotifiedDay", v.toEpochDay())
        }
}
